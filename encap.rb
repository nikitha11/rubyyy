class Message
	...
	def send_to_all
		...
		restricted_person
		# give private and protected names for public
	end
...
friend = Friend.new
# friend.restricted_person 
# - protected method `restricted_person' called for #<Sender:0x007ff5aa869820>
